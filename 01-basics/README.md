...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?color=00F7FF&center=true&vCenter=true&lines=Daily+JavaScript+Practice;Logic+Building+in+Progress;Consistency+%3D+Mastery" />
</p>
...
This repository contains my **daily JavaScript practice questions**.

I am solving problems step by step to improve my **logic building** and strengthen my understanding of **core JavaScript concepts**.
...
```txt
Understand → Think → Code → Debug → Improve → Repeat
```

This is the exact process I follow while solving every problem.
...
```txt
Input → Logic → Execution → Output → Optimization
```

Every problem is solved with a focus on:
...
18. Find Square Root
19. Check Divisible by 5 and 3
20. Calculate Total Marks and Percentage
...
33. Print Even Numbers (1 to 20)
34. Print Numbers from 10 to 1
35. Print Odd Numbers (1 to 15)
36. Multiplication Table of 5
37. Sum from 1 to 100
38. Numbers Divisible by 3 (1 to 50)
39. Even/Odd Check from 1 to N
40. Count Numbers Divisible by 3 and 5

---

### 🔹 Advanced Basics (41–50)
...
│   ├── 31-reverse-number.js  
│   ├── 32-print-1-to-10.js  
│   ├── 33-even-1-to-20.js  
│   ├── 34-reverse-10-to-1.js  
│   ├── 35-odd-1-to-15.js  
│   ├── 36-table-of-5.js  
│   ├── 37-sum-1-to-100.js  
...
```txt
Consistency → Practice → Clarity → Confidence → Mastery
```
